...
public final class TelaAdd_Armazem_Beira extends JFrame implements ActionListener, Config_idiomas {
    ...
    public TelaAdd_Armazem_Beira() throws SQLException {
    ...
    private void Janela() {        
        if(Idiomas.getPort() == true) {
            setTitle("REGISTRO  DE  PRODUTOS - #ARMAZÉM DA BEIRA");
        } else {
            setTitle("PRODUCTS REGISTER - #BEIRA WAREHOUSE");
        }
        setSize(560, 290);        
    ...
    private void configListarDesignacao() {
        ...
        String sql = "select * from tbarmazem_beira where designação like '%" + txtDesignacao.getText() + "%'";
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - TelaAdd_Armazem_Beira \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - TelaAdd_Armazem_Beira \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() - TelaAdd_Armazem_Beira \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca() - TelaAdd_Armazem_Beira \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            txtCategoria = new JComboBox<>(comboBoxModel);
                ...
                if(Idiomas.getPort() == true) {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();        
                        JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - TelaAdd_Armazem_Beira \n" + erro, "Atenção", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaAdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                    }
            } else {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();
                        JOptionPane.showMessageDialog(null, "Error in txtCategoria() - TelaAdd_Armazem_Beira \n" + erro, "Attention", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaAdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                    }
            }
    ...
    private void adicionar() {
        String sql = "INSERT INTO tbarmazem_beira(designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd) VALUES(?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO AO TENTAR ADCIONAR PRODUTO - TelaAdd_Armazem_Beira !", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE WHEN TRYING TO ADD PRODUCT - TelaAdd_Armazem_Beira !", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
