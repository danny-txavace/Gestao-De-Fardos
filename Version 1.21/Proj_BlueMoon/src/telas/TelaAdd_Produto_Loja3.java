...
public final class TelaAdd_Produto_Loja3 extends JFrame implements ActionListener, Config_idiomas {
    ...
    public TelaAdd_Produto_Loja3() throws SQLException {
    ...
    private void Janela() {        
        if(Idiomas.getPort() == true) {
            setTitle("REGISTRO  DE  PRODUTOS - #LOJA_3");
        } else {
            setTitle("PRODUCTS REGISTER - #SHOP_3");
        }
        setSize(560, 290);        
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - TelaAdd_Produto_Loja3 \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Produto_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - TelaAdd_Produto_Loja3 \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Produto_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() - TelaAdd_Produto_Loja3 \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Produto_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca() - TelaAdd_Produto_Loja3 \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Produto_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            txtCategoria = new JComboBox<>(comboBoxModel);
                ...
                if(Idiomas.getPort() == true) {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();        
                        JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - TelaAdd_Produto_Loja3 \n" + erro, "Atenção", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaAdd_Produto_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                    }
            } else {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();
                        JOptionPane.showMessageDialog(null, "Error in txtCategoria() - TelaAdd_Produto_Loja3 \n" + erro, "Attention", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaAdd_Produto_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                    }
            }
    ...
    private void adicionar() {
        String sql = "INSERT INTO tbloja_3(designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd) VALUES(?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO AO TENTAR ADCIONAR PRODUTO - TelaAdd_Produto_Loja3 !", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Produto_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE WHEN TRYING TO ADD PRODUCT - TelaAdd_Produto_Loja3 !", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Produto_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
