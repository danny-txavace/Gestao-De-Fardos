...
public final class TelaAdd_Venda_Loja1 extends JFrame implements ActionListener, Config_idiomas {
    ...
    public TelaAdd_Venda_Loja1() throws SQLException {
    ...
    private void configView() throws SQLException {
        ...
        lbluser.setBounds(557, 43, 50, 28);
        
        if(("admin".equals(Usuario.getUsuarioPerfil())) || (!"admin".equals(Usuario.getUsuarioPerfil()))) {
            txtuser.setForeground(Color.blue);
        }
        
        txtuser.setText(Usuario.getUsuarioNome());
        txtuser.setFont(new Font("Times New Roman", 0, 15));
        txtuser.setBounds(613, 43, 207, 28);
    ...
    private void configListarDesignacao() {
        ...
        String sql = "select * from tbloja_1 where MARCA = ? and CATEGORIA = ? and DESIGNAÇÃO like '%" + txtDesignacao.getText() + "%'";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                listaDesignacao.addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        ...
                        String sql2 = "select * from tbloja_1 where DESIGNAÇÃO = ?";
                            try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - TelaAdd_Venda_Loja1 \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - TelaAdd_Venda_Loja1 \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() - TelaAdd_Venda_Loja1 \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca() - TelaAdd_Venda_Loja1 \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            txtCategoria = new JComboBox<>(comboBoxModel);
                ...
                if(Idiomas.getPort() == true) {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();        
                        JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - TelaAdd_Venda_Loja1 \n" + erro, "Atenção", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();
                        JOptionPane.showMessageDialog(null, "Error in txtCategoria()- TelaAdd_Venda_Loja1 \n" + erro, "Attention", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                    }
            }
    ...
    private void temp_venda_1() throws SQLException {
        Statement ctemp = conexao.createStatement();
        ctemp.executeUpdate("create temporary table temp_tbvenda_1 like tbvenda_1");         
    }
    
    private void tabelaDAO() {
        String sql = "SELECT ID, DESIGNAÇÃO,QUANTIDADE, PRECO_VENDA FROM temp_tbvenda_1";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() - TelaAdd_Venda_Loja1", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERROR IN DAO_TABLE() - TelaAdd_Venda_Loja1 ", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }            
    ...
    private void salvar() throws SQLException {
        String sql = "insert into temp_tbvenda_1(designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd, preco_venda, vendido_por) values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try {
            pst = conexao.prepareStatement(sql);
            ...
            pst.setString(9, Usuario.getUsuarioNome());
            ...
            if(Idiomas.getPort() == true) {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO AO TENTAR SALVAR UMA VENDA - TelaAdd_Venda_Loja1 !", "AVISO", 0);
            } else {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE WHEN TRYING TO SAVE - TelaAdd_Venda_Loja1!", "WARNING", 0);
            }
        }
        
        String sql2 = "select sum( PRECO_VENDA ) as somatempvenda_1 from temp_tbvenda_1";
        double somaVlr = 0;
        try{
            rs = conexao.createStatement().executeQuery(sql2);
            
            while (rs.next()) {
                somaVlr = rs.getDouble("somatempvenda_1");
            }          
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERRO NO save() somatempvenda_1 - TelaAdd_Venda_Loja1 ..! "+err, "Atenção", 0);
            } else {
                this.rs.close();
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERROR IN save() somatempvenda_1 - TelaAdd_Venda_Loja1..! "+err, "Attention", 0);
            }            
        }        
    }
     
    private void configVenda() {
        String sql = "insert into tbvenda_1(designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd, preco_venda, vendido_por) select designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd, preco_venda, vendido_por from temp_tbvenda_1 ";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configVenda() - TelaAdd_Venda_Loja1 !", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configVenda() - TelaAdd_Venda_Loja1!", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void configUpdateLoja_1() throws SQLException {
        String sqlTemp = "select DESIGNAÇÃO, QUANTIDADE from temp_tbvenda_1";
        
        pst = conexao.prepareStatement(sqlTemp);
        rs = pst.executeQuery();
        
        String sqlUpdate = "update tbloja_1 set QUANTIDADE = QUANTIDADE - ? WHERE DESIGNAÇÃO = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configUpdateLoja_1() - TelaAdd_Venda_Loja1 !", "AVISO", 0);
            } else {
                this.pst.close();
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configUpdateLoja_1() - TelaAdd_Venda_Loja1!", "WARNING", 0);
            }
        }
    }
    
    private void limparTabela() {
        String sql = "drop temporary table temp_tbvenda_1";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no limparTabela() - TelaAdd_Venda_Loja1 !", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in limparTabela() - TelaAdd_Venda_Loja1!", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public void remover() {
        String sql = "delete from temp_tbvenda_1 where ID = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null," ERRO no remover() - TelaAdd_Venda_Loja1...! "+Er, "Atenção",0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO DELETE in remove() - TelaAdd_Venda_Loja1...! "+Er, "Attention",0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
