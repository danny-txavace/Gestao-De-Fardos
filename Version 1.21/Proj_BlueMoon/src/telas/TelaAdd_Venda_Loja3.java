...
public final class TelaAdd_Venda_Loja3 extends JFrame implements ActionListener, Config_idiomas {
    ...
    public TelaAdd_Venda_Loja3() throws SQLException {
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - TelaAdd_Venda_Loja3 \n" + erro, "Atenção", 0);
                ...
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - TelaAdd_Venda_Loja3 \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() - TelaAdd_Venda_Loja3 \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca() - TelaAdd_Venda_Loja3 \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            txtCategoria = new JComboBox<>(comboBoxModel);
                ...
                if(Idiomas.getPort() == true) {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();        
                        JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - TelaAdd_Venda_Loja3 \n" + erro, "Atenção", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaAdd_Venda_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();
                        JOptionPane.showMessageDialog(null, "Error in txtCategoria()- TelaAdd_Venda_Loja3 \n" + erro, "Attention", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaAdd_Venda_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                    }
            }
    ...
    private void temp_venda_3() throws SQLException {
        Statement ctemp = conexao.createStatement();
        ctemp.executeUpdate("create temporary table temp_tbvenda_3 like tbvenda_3");         
    }
    
    private void tabelaDAO() {
        String sql = "SELECT ID, DESIGNAÇÃO,QUANTIDADE, PRECO_VENDA FROM temp_tbvenda_3";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() - TelaAdd_Venda_Loja3", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERROR IN DAO_TABLE() - TelaAdd_Venda_Loja3", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            }            
    ...
    private void salvar() throws SQLException {
        String sql = "insert into temp_tbvenda_3(designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd, preco_venda, vendido_por) values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try {
            pst = conexao.prepareStatement(sql);
            ...
            if(Idiomas.getPort() == true) {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO AO TENTAR SALVAR UMA VENDA - TelaAdd_Venda_Loja3!", "AVISO", 0);
            } else {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE WHEN TRYING TO SAVE - TelaAdd_Venda_Loja3!", "WARNING", 0);
            }
        }
        
        String sql2 = "select sum( PRECO_VENDA ) as somatempvenda_3 from temp_tbvenda_3";
        double somaVlr = 0;
        try{
            rs = conexao.createStatement().executeQuery(sql2);
            
            while (rs.next()) {
                somaVlr = rs.getDouble("somatempvenda_3");
            }          
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERRO NO save() somatempvenda_3 - TelaAdd_Venda_Loja3 ..! "+err, "Atenção", 0);
            } else {
                this.rs.close();
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERROR IN save() somatempvenda_3 - TelaAdd_Venda_Loja3..! "+err, "Attention", 0);
            }            
        }        
    }
     
    private void configVenda() {
        String sql = "insert into tbvenda_3(designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd, preco_venda, vendido_por) select designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd, preco_venda, vendido_por from temp_tbvenda_3";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configVenda() - TelaAdd_Venda_Loja3!", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configVenda() - TelaAdd_Venda_Loja3!", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void configUpdateLoja_3() throws SQLException {
        String sqlTemp = "select DESIGNAÇÃO, QUANTIDADE from temp_tbvenda_3";
        
        pst = conexao.prepareStatement(sqlTemp);
        rs = pst.executeQuery();
        
        String sqlUpdate = "update tbloja_3 set QUANTIDADE = QUANTIDADE - ? WHERE DESIGNAÇÃO = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configUpdateLoja_3() - TelaAdd_Venda_Loja3 !", "AVISO", 0);
            } else {
                this.pst.close();
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configUpdateLoja_3() - TelaAdd_Venda_Loja3 !", "WARNING", 0);
            }
        }
    }
    
    private void limparTabela() {
        String sql = "drop temporary table temp_tbvenda_3";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no limparTabela() - TelaAdd_Venda_Loja3!", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in limparTabela() - TelaAdd_Venda_Loja3!", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public void remover() {
        String sql = "delete from temp_tbvenda_3 where ID = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null," ERRO no remover() - TelaAdd_Venda_Loja2...! "+Er, "Atenção",0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO DELETE in remove() - TelaAdd_Venda_Loja2...! "+Er, "Attention",0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_Loja3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
