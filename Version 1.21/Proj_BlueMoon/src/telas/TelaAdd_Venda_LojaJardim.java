...
public final class TelaAdd_Venda_LojaJardim extends JFrame implements ActionListener, Config_idiomas {
    private JLabel lbluser, txtuser, lblfundo, lbltitulo, lblloja_1, lblDesignacao, lblMarca, lblCategoria, lblUnidade, lblQuantidade, lblQuantidade_Disp, txtQuantidade_Disp, lblVenda_MZN, tituloVenda, txtArtigo_MZN, txtArtigo_USD, tituloTotal, txtTotal_MZN, txtTotal_USD, lbltotalPago, txttotalPago, mzn, usd, mznT, usdT, mznV;
    private JTextField txtDesignacao, txtMarca, txtUnidade, txtVenda_MZN;
    private JComboBox txtCategoria;
    private JSpinner txtQuantidade;
    private JButton btnAdicionar, btnCancelar, btnVender, btnRemover, btnSair, btnAtualizar_Tb;
    ...
    public TelaAdd_Venda_LojaJardim() throws SQLException {
    ...
    private void configView() throws SQLException {
        ...
        lblloja_1.setBounds(855, 2, 150, 21);
        
        lbluser.setText("Seller :");
        lbluser.setFont(new Font("Times New Roman", 1, 16));
        lbluser.setForeground(Color.BLACK);
        lbluser.setBounds(557, 41, 50, 28);
        
        txtuser.setText("Jardim_Shop");
        txtuser.setFont(new Font("Times New Roman", 0, 15));
        txtuser.setForeground(Color.blue);
        txtuser.setBounds(613, 41, 80, 28);
        txtuser.setOpaque(false);
        txtuser.setBorder(new MatteBorder(0,0,1,0, Color.black));
        ...
        txtQuantidade_Disp.setBounds(255, 182, 65, 28);
        ...
        lbltotalPago.setFont(new Font("Times New Roman", 1, 17));
        lbltotalPago.setForeground(Color.black);
        lbltotalPago.setBounds(557, 411, 176, 28);
        
        mznV.setText("MZN");
        mznV.setFont(new Font("Agency FB", 0, 17));
        mznV.setForeground(Color.black);
        mznV.setBounds(737, 411, 25, 28);
        
        txttotalPago.setText("0.0");
        txttotalPago.setFont(new Font("Agency FB", 0, 18));
        txttotalPago.setForeground(Color.black);
        txttotalPago.setBounds(765, 411, 110, 28);
        
        btnVender.setFont(new Font("Agency FB", 1, 20));
        btnVender.setForeground(Color.BLACK);
        btnVender.setBounds(557, 500, 150, 30);
        ...
        lblfundo.add(lbltotalPago);
        lblfundo.add(mznV);
        lblfundo.add(txttotalPago);
        lblfundo.add(btnVender);
    ...
    private void configListarDesignacao() {
        ...
        String sql = "select * from tbloja_jardim where MARCA = ? and CATEGORIA = ? and DESIGNAÇÃO like '%" + txtDesignacao.getText() + "%'";
        ...
        try {
                ...
                if (encontrou || txtDesignacao.getText().isEmpty()) {
                    ...
                    listaDesignacao.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseClicked(MouseEvent e) {
                            ...
                            String sql2 = "select * from tbloja_jardim where DESIGNAÇÃO = ?";
                            try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - TelaAdd_Venda_LojaJardim \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - TelaAdd_Venda_LojaJardim \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() - TelaAdd_Venda_LojaJardim \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca() - TelaAdd_Venda_LojaJardim \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            txtCategoria = new JComboBox<>(comboBoxModel);
                ...
                if(Idiomas.getPort() == true) {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();        
                        JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - TelaAdd_Venda_LojaJardim \n" + erro, "Atenção", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();
                        JOptionPane.showMessageDialog(null, "Error in txtCategoria()- TelaAdd_Venda_LojaJardim \n" + erro, "Attention", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                    }
            }
    ...
    private void temp_venda_Jardim() throws SQLException {
        Statement ctemp = conexao.createStatement();
        ctemp.executeUpdate("create temporary table temp_tbvenda_jardim like tbvenda_jardim");         
    }
    
    private void tabelaDAO() {
        String sql = "SELECT ID, DESIGNAÇÃO,QUANTIDADE, PRECO_VENDA FROM temp_tbvenda_jardim";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() - TelaAdd_Venda_LojaJardim", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERROR IN DAO_TABLE() - TelaAdd_Venda_LojaJardim ", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }            
    ...
    private void salvar() throws SQLException {
        String sql = "insert into temp_tbvenda_jardim(designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd, preco_venda, vendido_por) values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try {
            pst = conexao.prepareStatement(sql);
            ...
            pst.setString(9, lblloja_1.getText());
            ...
            if(Idiomas.getPort() == true) {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO AO TENTAR SALVAR UMA VENDA - TelaAdd_Venda_LojaJardim !", "AVISO", 0);
            } else {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE WHEN TRYING TO SAVE - TelaAdd_Venda_LojaJardim", "WARNING", 0);
            }
        }
        
        String sql2 = "select sum( PRECO_VENDA ) as somatempvenda_jardim from temp_tbvenda_jardim";
        double somaVlr = 0;
        try{
            rs = conexao.createStatement().executeQuery(sql2);
            
            while (rs.next()) {
                somaVlr = rs.getDouble("somatempvenda_jardim");
            }          
            
            txttotalPago.setText(""+somaVlr);
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERRO NO save() somatempvenda_Jardim - TelaAdd_Venda_LojaJardim..! "+err, "Atenção", 0);
            } else {
                this.rs.close();
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERROR IN save() somatempvenda_Jardim - TelaAdd_Venda_LojaJardim..! "+err, "Attention", 0);
            }            
        }        
    }
     
    private void configVenda() {
        String sql = "insert into tbvenda_jardim(designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd, preco_venda, vendido_por) select designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd, preco_venda, vendido_por from temp_tbvenda_jardim";
        ...
        try {
            ...
            if (adicionado > 0) {
                configUpdateLoja_Jardim();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "Vendido com sucesso !", "Atenção", 1);
                } else {
                    JOptionPane.showMessageDialog(null, "Sold out", "Wonderfully", 1);
                }
            }        
        } catch (HeadlessException | SQLException erro) {
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configVenda() - TelaAdd_Venda_LojaJardim !", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configVenda() - TelaAdd_Venda_LojaJardim!", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void configUpdateLoja_Jardim() throws SQLException {
        String sqlTemp = "select DESIGNAÇÃO, QUANTIDADE from temp_tbvenda_jardim";
        
        pst = conexao.prepareStatement(sqlTemp);
        rs = pst.executeQuery();
        
        String sqlUpdate = "update tbloja_jardim set QUANTIDADE = QUANTIDADE - ? WHERE DESIGNAÇÃO = ?";
        
        try {
            PreparedStatement pstup = conexao.prepareStatement(sqlUpdate);
            
            while(rs.next()) {
                String designacao = rs.getString("DESIGNAÇÃO");
                int quantTemp = rs.getInt("QUANTIDADE");
                
                pstup.setInt(1, quantTemp);
                pstup.setString(2, designacao);
                pstup.executeUpdate();
            }
        } catch (HeadlessException | SQLException erro) {
            if(Idiomas.getPort() == true) {
                ...
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configUpdateLoja_Jardim() - TelaAdd_Venda_LojaJardim !", "AVISO", 0);
            } else {
                this.pst.close();
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configUpdateLoja_Jardim() - TelaAdd_Venda_LojaJardim!", "WARNING", 0);
            }
        }
    }
    
    private void limparTabela() {
        String sql = "drop temporary table temp_tbvenda_jardim";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no limparTabela() - TelaAdd_Venda_LojaJardim!", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in limparTabela() - TelaAdd_Venda_LojaJardim!", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public void remover() {
        String sql = "delete from temp_tbvenda_jardim where ID = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null," ERRO no remover() - TelaAdd_Venda_LojaJardim...! "+Er, "Atenção",0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO DELETE in remove() - TelaAdd_Venda_LojaJardim...! "+Er, "Attention",0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaAdd_Venda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public void actionPerformed(ActionEvent evt) {
        if(evt.getSource() == btnAdicionar) {
            ...
            limparTela();  
            validar();
        } else if(evt.getSource() == btnVender) {
            configVenda();
    ...
    public void configPort() {
        ...
        lbltitulo.setText("REGISTRO DE VENDAS");
        ...
        lbltotalPago.setText("Preço total a pagar : ");
    ...
    public void configEng() {
        ...
        lbltitulo.setText("SELLING REGISTER");
        lblloja_1.setText("# JARDIM_SHOP");
        lblQuantidade_Disp.setText("Available quantity : ");       
        tituloVenda.setText("Article price : ");
        tituloTotal.setText("Total price : ");
        lbltotalPago.setText("Total payment amount : ");
        btnVender.setText("Sell");
