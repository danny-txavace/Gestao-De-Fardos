...
public final class TelaArmazem_Beira extends JInternalFrame implements ActionListener, Config_idiomas, Config_remover {
    private JLabel lbltitulo, lblpesquisa, lbltotal;
    ...
    private TelaAdd_Armazem_Beira telaAproduto = null;
    private TelaEdd_Armazem_Beira telaEproduto = null;
    private Transferir_ArmazemBeira transferir = null;
    
    public TelaArmazem_Beira() throws SQLException {
    ...
    private void configView() {
        ...
        lbltitulo.setBounds(5, 0, 750, 30);
        ...
        if(evt.getSource() == btnRemover) {
            ...
            SwingUtilities.invokeLater(() -> {
                if(telaAproduto == null || !telaAproduto.isVisible()) {
                    try {
                        telaAproduto = new TelaAdd_Armazem_Beira();
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                    }
            ...
            SwingUtilities.invokeLater(() -> {
                if(transferir == null || !transferir.isVisible()) {
                    transferir = new Transferir_ArmazemBeira();
    ...
    private void tabelaDAO() {
        tabelaDAOProced();
        String sql = "select * from tbarmazem_beira";
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() - ARMAZÉM DA BEIRA", "TBL   DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE DAO_TABLE() - BEIRA WAREHOUSE", "TBL   DAO", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void tabelaDAOProced() {
        String sql = "call Proced_Organizartbarmazem_beira()";
        try {
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
        } catch(SQLException er) {
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERRO NO PROCED_TABELA_DAO() - ARMAZÉM DA BEIRA", "PROCED  TBL  DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null,er + " ERROR IN THE DAO_TABLE_PROCED() - BEIRA WAREHOUSE", "DAO  TBL  PROCED", 0);
            } 
        }
    }
    
    private void pesquisar() {
        String sql = "select * from tbarmazem_beira where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{            
            ...
            try {
                ...
                this.pst.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR PESQUISAR - ARMAZÉM DA BEIRA..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO SEARCH - BEIRA WAREHOUSE..! \n"+err, "Attention", 0);            
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if(tabela.getSelectedRow() == -1) {
            if(Idiomas.getPort() == true) {
                ...
                if(telaEproduto == null || !telaEproduto.isVisible()) {
                    try {
                        telaEproduto = new TelaEdd_Armazem_Beira();
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    private void calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as quant from tbarmazem_beira";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Quant() - ARMAZÉM DA BEIRA..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Quant() - BEIRA WAREHOUSE..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as Pquant from tbarmazem_beira where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.conexao.close();
                    this.rs.close();
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Quant() - ARMAZÉM DA BEIRA..! \n"+err, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Quant() - BEIRA WAREHOUSE..! \n"+err, "Attention", 0);
            }            
        }
    }
    
    private void calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as somaartigomzn from tbarmazem_beira";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_MZN() - ARMAZÉM DA BEIRA ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_MZN() - BEIRA WAREHOUSE..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as Psomaartigomzn from tbarmazem_beira where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_MZN() - ARMAZÉM DA BEIRA..! \n"+err, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_MZN() - BEIRA WAREHOUSE..! \n"+err, "Attention", 0);
            }            
        }
    }
    
    private void calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as somatotalmzn from tbarmazem_beira";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_MZN() - ARMAZÉM DA BEIRA ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Total_MZN() - BEIRA WAREHOUSE..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as Psomatotalmzn from tbarmazem_beira where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_MZN() - ARMAZÉM DA BEIRA..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_MZN() - BEIRA WAREHOUSE..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Artigo_USD() {
        String sql = "select sum( PRECO_ARTIGO_USD ) as somaartigousd from tbarmazem_beira";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_USD() - ARMAZÉM DA BEIRA ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_USD() - BEIRA WAREHOUSE ..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_USD() {
        String sql = "select sum( PRECO_ARTIGO_USD ) as Psomaartigousd from tbarmazem_beira where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_USD() - ARMAZÉM DA BEIRA ..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_USD() - BEIRA WAREHOUSE ..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Total_USD() {
        String sql_quant = "select sum( PRECO_TOTAL_USD ) as somatotalusd from tbarmazem_beira";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_USD() - ARMAZÉM DA BEIRA ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN  calc_Preco_Total_USD() - BEIRA WAREHOUSE ..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_USD() {
        String sql = "select sum( PRECO_TOTAL_USD ) as Psomatotalusd from tbarmazem_beira where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_USD() - ARMAZÉM DA BEIRA ..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_USD() - BEIRA WAREHOUSE ..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaArmazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void configPort() {
        lbltitulo.setText("*  A R M A Z É M   D A   B E I R A  *");
    ...
    public void configEng() {
        lbltitulo.setText("*  B E I R A   W A R E H O U S E  *");
        lbltitulo.setFont(new Font("Times New Roman", 3, 21));
    ...
    public void remover1() {
        String sql = "delete from tbarmazem_beira where ID = ?";
        model = (DefaultTableModel) tabela.getModel();
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                JOptionPane.showMessageDialog(null," ERRO AO TENTAR DELETAR - ARMAZÉM DA BEIRA...! "+Er, "Atenção",0);
            } else {
                JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO DELETE - BEIRA WAREHOUSE...! "+Er, "Attention",0);
            }
    ...
    public void remover2() {
        int[] sr = tabela.getSelectedRows();
        String sql = "delete from tbarmazem_beira where ID in (?, ?)";
        model = (DefaultTableModel) tabela.getModel();
        try {
            pst = conexao.prepareStatement(sql);
    ...
    public void remover3() {
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                JOptionPane.showMessageDialog(null," ERRO AO TENTAR DELETAR - ARAMAZÉM DA BEIRA...! "+Er, "Atenção",0);
            } else {
                JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO DELETE - BEIRA WAREHOUSE...! "+Er, "Attention",0);
            }
