...
public final class TelaEdd_Armazem_Beira extends JFrame implements ActionListener, Config_idiomas {
    ...
    public TelaEdd_Armazem_Beira() throws SQLException {
    ...
    private void configListarDesignacao() {
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - TelaEdd_Armazem_Beira \n" + erro, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - TelaEdd_Armazem_Beira \n" + erro, "Attention", 0);
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaEdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private void configListarMarca() {
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() - TelaEdd_Armazem_Beira \n" + erro, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca()- TelaEdd_Armazem_Beira \n" + erro, "Attention", 0);
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaEdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void txtCategoria() {
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - TelaEdd_Armazem_Beira.\n" + err.getMessage());
                } else {
                    JOptionPane.showMessageDialog(null, "Error in txtCategoria() - TelaEdd_Armazem_Beira.\n" + err.getMessage());
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaEdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void update() {
        String sql = "update tbarmazem_beira set designação = ?, marca = ?, categoria = ?, unidade = ?, quantidade = ?, preco_artigo_mzn = ?, preco_artigo_usd = ? where id = ?";
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO AO TENTAR ATUALIZAR - TelaEdd_Armazem_Beira !", "AVISO", 0);
                } else {
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE WHEN TRYING TO UPDATE - TelaEdd_Armazem_Beira !", "WARNING", 0);
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaEdd_Armazem_Beira.class.getName()).log(Level.SEVERE, null, ex);
            }
