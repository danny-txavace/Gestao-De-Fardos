...
public final class TelaEdd_Produto_Loja1 extends JFrame implements ActionListener, Config_idiomas {
    ...
    public TelaEdd_Produto_Loja1() throws SQLException {
    ...
    private void configListarDesignacao() {
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - PRODUTO_EDD_LOJA_1 \n" + erro, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - PRODUCT_EDD_SHOP_1 \n" + erro, "Attention", 0);
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaEdd_Produto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private void configListarMarca() {
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() PRODUTO_EDD_LOJA_1 \n" + erro, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca()- PRODUCT_EDD_SHOP_1 \n" + erro, "Attention", 0);
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaEdd_Produto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void txtCategoria() {
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - PRODUTO_EDD_LOJA_1.\n" + err.getMessage());
                } else {
                    JOptionPane.showMessageDialog(null, "Error in txtCategoria() - PRODUCT_EDD_SHOP_1.\n" + err.getMessage());
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaEdd_Produto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void update() {
        String sql = "update tbloja_1 set designação = ?, marca = ?, categoria = ?, unidade = ?, quantidade = ?, preco_artigo_mzn = ?, preco_artigo_usd = ? where id = ?";
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO AO TENTAR ATUALIZAR - PRODUTO_EDD_LOJA_1 !", "AVISO", 0);
                } else {
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE WHEN TRYING TO UPDATE - PRODUCT_EDD_SHOP_1 !", "WARNING", 0);
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaEdd_Produto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
