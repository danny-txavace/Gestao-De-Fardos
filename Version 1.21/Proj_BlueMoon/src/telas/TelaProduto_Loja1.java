...
public final class TelaProduto_Loja1 extends JInternalFrame implements ActionListener, Config_idiomas, Config_remover {
    ...
    private TelaAdd_Produto_Loja1 telaAproduto1 = null;
    private TelaEdd_Produto_Loja1 telaEproduto1 = null;
    private Transferir_Loja1 transferir = null;
    
    public TelaProduto_Loja1() throws SQLException {
    ...
    public void actionPerformed(ActionEvent evt) {
        if(evt.getSource() == btnRemover) {
            ...
            SwingUtilities.invokeLater(() -> {
                if(telaAproduto1 == null || !telaAproduto1.isVisible()) {
                    try {
                        telaAproduto1 = new TelaAdd_Produto_Loja1();
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    telaAproduto1.setVisible(true);
                    telaAproduto1.toFront();
                } else {
                    telaAproduto1.toFront();
                }
            });
            ...
            SwingUtilities.invokeLater(() -> {
                if(transferir == null || !transferir.isVisible()) {
                    transferir = new Transferir_Loja1();
    ...
    private void tabelaDAO() {
        tabelaDAOProced();
        String sql = "select * from tbloja_1";
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() - TelaProduto_Loja1", "TBL   DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE DAO_TABLE() - TelaProduto_Loja1", "TBL   DAO", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void tabelaDAOProced() {
        String sql = "call Proced_Organizartbloja_1()";
        try {
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
        } catch(SQLException er) {
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERRO NO PROCED_TABELA_DAO() - TelaProduto_Loja1", "PROCED  TBL  DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null,er + " ERROR IN THE DAO_TABLE_PROCED() - TelaProduto_Loja1", "DAO  TBL  PROCED", 0);
            } 
        }
    }
    
    private void pesquisar() {
        String sql = "select * from tbloja_1 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{            
            ...
            try {
                ...
                this.pst.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR PESQUISAR - TelaProduto_Loja1..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO SEARCH - TelaProduto_Loja1..! \n"+err, "Attention", 0);            
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void editar() {
        if(tabela.getSelectedRow() == -1) {
            if(Idiomas.getPort() == true) {
                ...
                SwingUtilities.invokeLater(() -> {
                if(telaEproduto1 == null || !telaEproduto1.isVisible()) {
                    try {
                        telaEproduto1 = new TelaEdd_Produto_Loja1();
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    telaEproduto1.setVisible(true);
                    telaEproduto1.toFront();
                    
                    int selectedRowIndex = tabela.getSelectedRow();
                    model = (DefaultTableModel) tabela.getModel();
                    telaEproduto1.txtID.setText(model.getValueAt(selectedRowIndex, 0).toString());
                    telaEproduto1.txtDesignacao.setText(model.getValueAt(selectedRowIndex, 1).toString());
                    telaEproduto1.txtMarca.setText(model.getValueAt(selectedRowIndex, 2).toString());
                    telaEproduto1.txtCategoria.setSelectedItem(model.getValueAt(selectedRowIndex, 3));
                    telaEproduto1.txtUnidade.setText(model.getValueAt(selectedRowIndex, 4).toString());
                    telaEproduto1.txtQuantidade.setValue(model.getValueAt(selectedRowIndex, 5));
                    telaEproduto1.txtPreco.setText(model.getValueAt(selectedRowIndex, 6).toString());
                    telaEproduto1.txtPrecousd.setText(model.getValueAt(selectedRowIndex, 8).toString());
                } else {
                    telaEproduto1.toFront();
                }
            });
    ...
    private void calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as quant from tbloja_1";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Quant() - TelaProduto_Loja1..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Quant() - TelaProduto_Loja1..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as Pquant from tbloja_1 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.conexao.close();
                    this.rs.close();
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Quant() - TelaProduto_Loja1..! \n"+err, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Quant() - TelaProduto_Loja1..! \n"+err, "Attention", 0);
            }            
        }
    }
    
    private void calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as somaartigomzn from tbloja_1";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_MZN() - TelaProduto_Loja1 ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_MZN() - TelaProduto_Loja1 ..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as Psomaartigomzn from tbloja_1 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_MZN() do PRODUTO_LOJA_1..! \n"+err, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_MZN() at PRODUCT_SHOP_1..! \n"+err, "Attention", 0);
            }            
        }
    }
    
    private void calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as somatotalmzn from tbloja_1";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_MZN() - TelaProduto_Loja1 ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Total_MZN() - TelaProduto_Loja1 ..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as Psomatotalmzn from tbloja_1 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_MZN() no PRODUTO_LOJA_1..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_MZN() at PRODUCT_SHOP_1..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Artigo_USD() {
        String sql = "select sum( PRECO_ARTIGO_USD ) as somaartigousd from tbloja_1";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_USD() - TelaProduto_Loja1 ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_USD() - TelaProduto_Loja1 ..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_USD() {
        String sql = "select sum( PRECO_ARTIGO_USD ) as Psomaartigousd from tbloja_1 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_USD() - TelaProduto_Loja1..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_USD() - TelaProduto_Loja1..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Total_USD() {
        String sql_quant = "select sum( PRECO_TOTAL_USD ) as somatotalusd from tbloja_1";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_USD() - TelaProduto_Loja1..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN  calc_Preco_Total_USD() - TelaProduto_Loja1.! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_USD() {
        String sql = "select sum( PRECO_TOTAL_USD ) as Psomatotalusd from tbloja_1 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_USD() - TelaProduto_Loja1..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_USD() - TelaProduto_Loja1..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_Loja1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void remover1() {
        String sql = "delete from tbloja_1 where ID = ?";
        model = (DefaultTableModel) tabela.getModel();
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                JOptionPane.showMessageDialog(null," ERRO AO TENTAR DELETAR - TelaProduto_Loja1...! "+Er, "Atenção",0);
            } else {
                JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO DELETE - TelaProduto_Loja1...! "+Er, "Attention",0);
            }
    ...
    public void remover2() {
        int[] sr = tabela.getSelectedRows();
        String sql = "delete from tbloja_1 where ID in (?, ?)";
        model = (DefaultTableModel) tabela.getModel();
        try {
            pst = conexao.prepareStatement(sql);
