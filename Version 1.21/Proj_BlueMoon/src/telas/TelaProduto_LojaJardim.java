...
public final class TelaProduto_LojaJardim extends JInternalFrame implements ActionListener, Config_idiomas, Config_remover {
    ...
    private TelaAdd_Produto_LojaJardim telaAproduto = null;
    private TelaEdd_Produto_LojaJardim telaEproduto = null;
    private Transferir_LojaJardim transferir = null;
    
    public TelaProduto_LojaJardim() throws SQLException {
    ...
    private void configView() {
        ...
        lblloja_1.setBounds(1170, 2, 200, 21);
        ...
        if(evt.getSource() == btnRemover) {
            ...
            SwingUtilities.invokeLater(() -> {
                if(telaAproduto == null || !telaAproduto.isVisible()) {
                    try {
                        telaAproduto = new TelaAdd_Produto_LojaJardim();
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                    }
            ...
            SwingUtilities.invokeLater(() -> {
                if(transferir == null || !transferir.isVisible()) {
                    transferir = new Transferir_LojaJardim();
    ...
    private void tabelaDAO() {
        tabelaDAOProced();
        String sql = "select * from tbloja_jardim";
        ...
        try {
            ...
            try {
                ...
                this.conexao.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() - TelaProduto_LojaJardim", "TBL   DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE DAO_TABLE() - TelaProduto_LojaJardim", "TBL   DAO", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void tabelaDAOProced() {
        String sql = "call Proced_Organizartbloja_jardim()";
        try {
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
        } catch(SQLException er) {
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERRO NO PROCED_TABELA_DAO() - TelaProduto_LojaJardim", "PROCED  TBL  DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null,er + " ERROR IN THE DAO_TABLE_PROCED() - TelaProduto_LojaJardim", "DAO  TBL  PROCED", 0);
            } 
        }
    }
    
    private void pesquisar() {
        String sql = "select * from tbloja_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{            
            ...
            try {
                ...
                this.pst.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR PESQUISAR - TelaProduto_LojaJardim..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO SEARCH - TelaProduto_LojaJardim..! \n"+err, "Attention", 0);            
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        if(tabela.getSelectedRow() == -1) {
            if(Idiomas.getPort() == true) {
                ...
                if(telaEproduto == null || !telaEproduto.isVisible()) {
                    try {
                        telaEproduto = new TelaEdd_Produto_LojaJardim();
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    private void calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as quant from tbloja_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Quant() - TelaProduto_LojaJardim..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Quant() - TelaProduto_LojaJardim..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as Pquant from tbloja_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.conexao.close();
                    this.rs.close();
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Quant() - TelaProduto_LojaJardim..! \n"+err, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Quant() - TelaProduto_LojaJardim..! \n"+err, "Attention", 0);
            }            
        }
    }
    
    private void calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as somaartigomzn from tbloja_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_MZN() - TelaProduto_LojaJardim..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_MZN() - TelaProduto_LojaJardim..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as Psomaartigomzn from tbloja_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_MZN() - TelaProduto_LojaJardim..! \n"+err, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_MZN() - TelaProduto_LojaJardim..! \n"+err, "Attention", 0);
            }            
        }
    }
    
    private void calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as somatotalmzn from tbloja_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_MZN() - TelaProduto_LojaJardim..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Total_MZN() - TelaProduto_LojaJardim..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as Psomatotalmzn from tbloja_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_MZN() - TelaProduto_LojaJardim..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_MZN() - TelaProduto_LojaJardim..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Artigo_USD() {
        String sql = "select sum( PRECO_ARTIGO_USD ) as somaartigousd from tbloja_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_USD() - TelaProduto_LojaJardim..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_USD() - TelaProduto_LojaJardim..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_USD() {
        String sql = "select sum( PRECO_ARTIGO_USD ) as Psomaartigousd from tbloja_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_USD() - TelaProduto_LojaJardim..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_USD() - TelaProduto_LojaJardim..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Total_USD() {
        String sql_quant = "select sum( PRECO_TOTAL_USD ) as somatotalusd from tbloja_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_USD() - TelaProduto_LojaJardim..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN  calc_Preco_Total_USD() - TelaProduto_LojaJardim..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_USD() {
        String sql = "select sum( PRECO_TOTAL_USD ) as Psomatotalusd from tbloja_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_USD() - TelaProduto_LojaJardim..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_USD() - TelaProduto_LojaJardim..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaProduto_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void remover1() {
        String sql = "delete from tbloja_jardim where ID = ?";
        model = (DefaultTableModel) tabela.getModel();
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                JOptionPane.showMessageDialog(null," ERRO AO TENTAR DELETAR - TelaProduto_LojaJardim...! "+Er, "Atenção",0);
            } else {
                JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO DELETE - TelaProduto_LojaJardim...! "+Er, "Attention",0);
            }
    ...
    public void remover2() {
        int[] sr = tabela.getSelectedRows();
        String sql = "delete from tbloja_jardim where ID in (?, ?)";
        model = (DefaultTableModel) tabela.getModel();
        try {
            pst = conexao.prepareStatement(sql);
