...
public final class TelaVenda_Loja2 extends JInternalFrame implements ActionListener, Config_idiomas, Config_remover {
    ...
    private TelaVenda_Loja2_Detalhes telaVendaDetalhes = null;
    private TelaAdd_Venda_Loja2 telaAddVenda = null;
    private TelaEdd_Venda_Loja2 telaEddVenda = null;
    
    public TelaVenda_Loja2() throws SQLException {
        ...
        if(evt.getSource() == btnRemover) {
            ...
            SwingUtilities.invokeLater(() -> {
                if(telaAddVenda== null || !telaAddVenda.isVisible()) {
                    try {
                        telaAddVenda = new TelaAdd_Venda_Loja2();
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
                    }
            ...
            SwingUtilities.invokeLater(() -> {
                if(telaVendaDetalhes == null || !telaVendaDetalhes.isVisible()) {
                    try {
                        telaVendaDetalhes = new TelaVenda_Loja2_Detalhes();
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    private void tabelaDAO() {
        tabelaDAOProced();
        String sql = "SELECT ID, DESIGNAÇÃO, MARCA, CATEGORIA, UNIDADE, QUANTIDADE, PRECO_ARTIGO_MZN, PRECO_TOTAL_MZN, PRECO_VENDA, LUCRO, DATA_HORA FROM tbvenda_2 WHERE DATA_HORA >= CURDATE()";
        ...
        try {
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() VENDA_LOJA_2", "TBL   DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE SELLING_SHOP_2 DAO_TABLE()", "TBL   DAO", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void tabelaDAOProced() {
        ...
        try {
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NO PROCED_TABELA_DAO() VENDA_LOJA_2", "PROCED  TBL  DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE SELLING_SHOP_2 DAO_TABLE_PROCED()", "DAO  TBL  PROCED", 0);
                } 
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar() {
        String sql = "select ID, DESIGNAÇÃO, MARCA, CATEGORIA, UNIDADE, QUANTIDADE, PRECO_ARTIGO_MZN, PRECO_TOTAL_MZN, PRECO_VENDA, LUCRO, DATA_HORA from tbvenda_2 where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{            
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR PESQUISAR VENDA_LOJA_2..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO SELLING_SHOP_2 SEARCH..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as quant from tbvenda_2 where DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Quant() na VENDA_LOJA_2..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Quant() at SELLING_SHOP_2..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as Pquant from tbvenda_2 where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Quant() na VENDA_LOJA_2..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Quant() in SELLING_SHOP_2..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as somaartigomzn from tbvenda_2 where DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_MZN() na VENDA_LOJA_2..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_MZN() at SELLING_SHOP_2..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as Psomaartigomzn from tbvenda_2 where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_MZN() na VENDA_LOJA_2..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_MZN() in SELLING_SHOP_2..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as somatotalmzn from tbvenda_2 where DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_MZN() na VENDA_LOJA_2 ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Total_MZN() at SELLING_SHOP_2..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as Psomatotalmzn from tbvenda_2 where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_MZN() na VENDA_LOJA_2..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_MZN() in SELLING_SHOP_2..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Venda_MZN() {
        String sql = "select sum( PRECO_VENDA ) as somavendamzn from tbvenda_2 where DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Venda_MZN() na VENDA_LOJA_2..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Venda_MZN() at SELLING_SHOP_2..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Venda_MZN() {
        String sql = "select sum( PRECO_VENDA ) as Psomavendamzn from tbvenda_2 where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Venda_MZN() na VENDA_LOJA_2..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Venda_MZN() in SELLING_SHOP_2..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Lucro_MZN() {
        String sql = "select sum( LUCRO ) as somalucro from tbvenda_2 where DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Lucro_MZN() na VENDA_LOJA_2 ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR in calc_Preco_Lucro_MZN() at SELLING_SHOP_2..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Lucro_MZN() {
        String sql = "select sum( LUCRO ) as Psomalucro from tbvenda_2 where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Lucro_MZN() na VENDA_LOJA_2..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Lucro_MZN() in SELLING_SHOP_2..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void editar() {
        if(tabela.getSelectedRow() == -1) {
            ...
            if(telaEddVenda == null || !telaEddVenda.isVisible()) {
                try {
                    telaEddVenda = new TelaEdd_Venda_Loja2();
                } catch (SQLException ex) {
                    Logger.getLogger(TelaVenda_Loja2.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public void remover1() {
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                JOptionPane.showMessageDialog(null," ERRO AO TENTAR DELETAR VENDA_LOJA_2...! "+Er, "Atenção",0);
            } else {
                JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO SELLING_SHOP_2 DELETE...! "+Er, "Attention",0);
            }
