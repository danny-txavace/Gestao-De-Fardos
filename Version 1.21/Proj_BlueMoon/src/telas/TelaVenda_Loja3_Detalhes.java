...
public final class TelaVenda_Loja3_Detalhes extends JFrame implements Config_idiomas, Config_remover, ActionListener {
    ...
    public TelaVenda_Loja3_Detalhes () throws SQLException {
    ...
    private void Janela() {
        if(Idiomas.getPort() == true) {
            setTitle("DETALHES _ #LOJA_3");
        } else {
            setTitle("DETAILS _ #SHOP_3");
        }
        setSize(700, 500);
    ...
    private void tabelaDAO() {
        tabelaDAOProced();
        String sql = "select * from tbvenda_3";
        ...
        try {
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() VENDA_DETALHES_LOJA_3", "TBL   DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE DETAILS_SELLING_SHOP_3 DAO_TABLE()", "TBL   DAO", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    
    private void tabelaDAOProced() {
        String sql = "call Proced_Organizartbvenda_3()";
        try {
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
        } catch(SQLException er) {
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NO PROCED_TABELA_DAO() VENDA_DETALHES_LOJA_3", "PROCED  TBL  DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE DETAILS_SELLING_SHOP_3 DAO_TABLE_PROCED()", "DAO  TBL  PROCED", 0);
                } 
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar() {
        String sql = "select * from tbvenda_3 where ID like ? || DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{            
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR PESQUISAR VENDA_DETALHES_LOJA_3..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO SALLING_DETAILS_SHOP_3 SEARCH..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as quant from tbvenda_3";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                JOptionPane.showMessageDialog(null, "ERRO NO calc_Quant() na VENDA_DETALHES_LOJA_3..! \n"+err, "Atenção", 0);
            } else {
                JOptionPane.showMessageDialog(null, "ERROR IN calc_Quant() at SELLING_DETAILS_SHOP_3..! \n"+err, "Attention", 0);
            }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as Pquant from tbvenda_3 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Quant() na VENDA_DETALHES_LOJA_3..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Quant() in SELLING_DETAILS_SHOP_3..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as somaartigomzn from tbvenda_3";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_MZN() na VENDA_DETALHES_LOJA_3 ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_MZN() at SELLING_DETAILS_SHOP_3..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as Psomaartigomzn from tbvenda_3 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_MZN() na VENDA_DETALHES_LOJA_3..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_MZN() in SELLING_DETAILS_SHOP_3..! \n"+err, "Attention", 0);            
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as somatotalmzn from tbvenda_3";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_MZN() na VENDA_DETALHES_LOJA_3..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Total_MZN() at SELLING_DETAILS_SHOP_3..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as Psomatotalmzn from tbvenda_3 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_MZN() na VENDA_DETALHES_LOJA_3..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_MZN() in SELLING_DETAILS_SHOP_3..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Artigo_USD() {
        String sql = "select sum( PRECO_ARTIGO_USD ) as somaartigousd from tbvenda_3";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_USD() na VENDA_DETALHES_LOJA_3..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_USD() at SELLING_DETAILS_SHOP_3..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_USD() {
        String sql = "select sum( PRECO_ARTIGO_USD ) as Psomaartigousd from tbvenda_3 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_USD() na VENDA_DETALHES_LOJA_3..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_USD() in SELLING_DETAILS_SHOP_3..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Total_USD() {
        String sql = "select sum( PRECO_TOTAL_USD ) as somatotalusd from tbvenda_3";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_USD() na VENDA_DETALHES_LOJA_3..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Total_USD() at SELLING_DETAILS_SHOP_3..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_USD() {
        String sql = "select sum( PRECO_TOTAL_USD ) as Psomatotalusd from tbvenda_3 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_USD() na VENDA_DETALHES_LOJA_3..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_USD() in SELLING_DETAILS_SHOP_3..! \n"+err, "Attention", 0);            
                }
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Venda_MZN() {
        String sql = "select sum( PRECO_VENDA ) as somavendamzn from tbvenda_3";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Venda_MZN() na VENDA_DETALHES_LOJA_3..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Venda_MZN() at SELLING_DETAILS_SHOP_3..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Venda_MZN() {
        String sql = "select sum( PRECO_VENDA ) as Psomavendamzn from tbvenda_3 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.conexao.close();
                    this.rs.close();
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Venda_MZN() na VENDA_DETALHES_LOJA_3..! \n"+err, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.conexao.close();
                    this.rs.close();
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Venda_MZN() in SELLING_DETAILS_SHOP_3..! \n"+err, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
                }
            }            
    ...
    private void calc_Preco_Lucro_MZN() {
        String sql = "select sum( LUCRO ) as somalucro from tbvenda_3";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Lucro_MZN() na VENDA_DETALHES_LOJA_3 ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR in calc_Preco_Lucro_MZN() at SELLING_DETAILS_SHOP_3..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Lucro_MZN() {
        String sql = "select sum( LUCRO ) as Psomalucro from tbvenda_3 where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Lucro_MZN() na VENDA_DETALHES_LOJA_3..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Lucro_MZN() in SELLING_DETAILS_SHOP_3..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_Loja3_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void remover1() {
        String sql = "delete from tbvenda_3 where ID = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                JOptionPane.showMessageDialog(null," ERRO AO TENTAR DELETAR VENDA_DETALHES_LOJA_3...! "+Er, "Atenção",0);
            } else {
                JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO SELLING_DETAILS_SHOP_3 DELETE...! "+Er, "Attention",0);
            }
    ...
    public void remover2() {
        int[] sr = tabela.getSelectedRows();
        String sql = "delete from tbvenda_3 where ID in (?, ?)";
        model = (DefaultTableModel) tabela.getModel();
        try {
            pst = conexao.prepareStatement(sql);
