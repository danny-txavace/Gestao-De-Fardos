...
public final class TelaVenda_LojaJardim extends JInternalFrame implements ActionListener, Config_idiomas, Config_remover {
    ...
    private TelaVenda_LojaJardim_Detalhes telaVendaDetalhes = null;
    private TelaAdd_Venda_LojaJardim telaAddVenda = null;
    private TelaEdd_Venda_LojaJardim telaEddVenda = null;
    
    public TelaVenda_LojaJardim() throws SQLException {
        ...
        if(evt.getSource() == btnRemover) {
            ...
            SwingUtilities.invokeLater(() -> {
                if(telaAddVenda== null || !telaAddVenda.isVisible()) {
                    try {
                        telaAddVenda = new TelaAdd_Venda_LojaJardim();
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                    }
            ...
            SwingUtilities.invokeLater(() -> {
                if(telaVendaDetalhes == null || !telaVendaDetalhes.isVisible()) {
                    try {
                        telaVendaDetalhes = new TelaVenda_LojaJardim_Detalhes();
                    } catch (SQLException ex) {
                        Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    private void tabelaDAO() {
        tabelaDAOProced();
        String sql = "SELECT ID, DESIGNAÇÃO, MARCA, CATEGORIA, UNIDADE, QUANTIDADE, PRECO_ARTIGO_MZN, PRECO_TOTAL_MZN, PRECO_VENDA, LUCRO, DATA_HORA FROM tbvenda_jardim WHERE DATA_HORA >= CURDATE()";
        ...
        try {
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() VENDA_LOJA_JARDIM", "TBL   DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE SELLING_SHOP_JARDIM DAO_TABLE()", "TBL   DAO", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void tabelaDAOProced() {
        ...
        try {
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NO PROCED_TABELA_DAO() VENDA_LOJA_JARDIM", "PROCED  TBL  DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE SELLING_SHOP_JARDIM DAO_TABLE_PROCED()", "DAO  TBL  PROCED", 0);
                } 
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar() {
        String sql = "select ID, DESIGNAÇÃO, MARCA, CATEGORIA, UNIDADE, QUANTIDADE, PRECO_ARTIGO_MZN, PRECO_TOTAL_MZN, PRECO_VENDA, LUCRO, DATA_HORA from tbvenda_jardim where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{            
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR PESQUISAR VENDA_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO SELLING_SHOP_JARDIM SEARCH..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as quant from tbvenda_jardim where DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Quant() na VENDA_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Quant() at SELLING_SHOP_JARDIM..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as Pquant from tbvenda_jardim where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Quant() na VENDA_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Quant() in SELLING_SHOP_JARDIM..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as somaartigomzn from tbvenda_jardim where DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_MZN() na VENDA_LOJA_JARDIM..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_MZN() at SELLING_SHOP_JARDIM..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as Psomaartigomzn from tbvenda_jardim where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_MZN() na VENDA_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_MZN() in SELLING_SHOP_JARDIM..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as somatotalmzn from tbvenda_jardim where DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_MZN() na VENDA_LOJA_JARDIM ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Total_MZN() at SELLING_SHOP_JARDIM..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as Psomatotalmzn from tbvenda_jardim where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_MZN() na VENDA_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_MZN() in SELLING_SHOP_JARDIM..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Venda_MZN() {
        String sql = "select sum( PRECO_VENDA ) as somavendamzn from tbvenda_jardim where DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Venda_MZN() na JARDIM..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Venda_MZN() at SELLING_SHOP_JARDIM..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Venda_MZN() {
        String sql = "select sum( PRECO_VENDA ) as Psomavendamzn from tbvenda_jardim where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Venda_MZN() na VENDA_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Venda_MZN() in SELLING_SHOP_JARDIM..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Lucro_MZN() {
        String sql = "select sum( LUCRO ) as somalucro from tbvenda_jardim where DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Lucro_MZN() na VENDA_LOJA_JARDIM..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR in calc_Preco_Lucro_MZN() at SELLING_SHOP_JARDIM..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Lucro_MZN() {
        String sql = "select sum( LUCRO ) as Psomalucro from tbvenda_jardim where DESIGNAÇÃO like ? and DATA_HORA >= CURDATE() || MARCA like ? and DATA_HORA >= CURDATE() || CATEGORIA like ? and DATA_HORA >= CURDATE() || DATA_HORA like ? and DATA_HORA >= CURDATE()";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Lucro_MZN() na VENDA_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Lucro_MZN() in SELLING_SHOP_JARDIM..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void editar() {
        if(tabela.getSelectedRow() == -1) {
            ...
            if(telaEddVenda == null || !telaEddVenda.isVisible()) {
                try {
                    telaEddVenda = new TelaEdd_Venda_LojaJardim();
                } catch (SQLException ex) {
                    Logger.getLogger(TelaVenda_LojaJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    public void remover1() {
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                JOptionPane.showMessageDialog(null," ERRO AO TENTAR DELETAR VENDA_LOJA_JARDIM...! "+Er, "Atenção",0);
            } else {
                JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO SELLING_SHOP_JARDIM DELETE...! "+Er, "Attention",0);
            }
