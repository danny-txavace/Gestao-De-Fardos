...
public final class TelaVenda_LojaJardim_Detalhes extends JFrame implements Config_idiomas, Config_remover, ActionListener {
    ...
    public TelaVenda_LojaJardim_Detalhes () throws SQLException {
    ...
    private void Janela() {
        if(Idiomas.getPort() == true) {
            setTitle("DETALHES _ #LOJA_JARDIM");
        } else {
            setTitle("DETAILS _ #JARDIM_SHOP");
        }
        setSize(700, 500);
    ...
    private void configView() {
        ...
        lblloja_1.setBounds(1170, 2, 150, 21);
    ...
    private void tabelaDAO() {
        tabelaDAOProced();
        String sql = "select * from tbvenda_jardim";
        ...
        try {
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() VENDA_DETALHES_LOJA_JARDIM", "TBL   DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE DETAILS_SELLING_SHOP_JARDIM DAO_TABLE()", "TBL   DAO", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    
    private void tabelaDAOProced() {
        String sql = "call Proced_Organizartbvenda_jardim()";
        try {
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
        } catch(SQLException er) {
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null,er + " ERRO NO PROCED_TABELA_DAO() VENDA_DETALHES_LOJA_JARDIM", "PROCED  TBL  DAO", 0);
                } else {
                    JOptionPane.showMessageDialog(null,er + " ERROR IN THE DETAILS_SELLING_SHOP_JARDIM DAO_TABLE_PROCED()", "DAO  TBL  PROCED", 0);
                } 
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar() {
        String sql = "select * from tbvenda_jardim where ID like ? || DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{            
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR PESQUISAR VENDA_DETALHES_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO SALLING_DETAILS_SHOP_JARDIM SEARCH..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as quant from tbvenda_jardim";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                JOptionPane.showMessageDialog(null, "ERRO NO calc_Quant() na VENDA_DETALHES_LOJA_JARDIM..! \n"+err, "Atenção", 0);
            } else {
                JOptionPane.showMessageDialog(null, "ERROR IN calc_Quant() at SELLING_DETAILS_SHOP_JARDIM..! \n"+err, "Attention", 0);
            }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Quant() {
        String sql = "select sum( QUANTIDADE ) as Pquant from tbvenda_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Quant() na VENDA_DETALHES_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Quant() in SELLING_DETAILS_SHOP_JARDIM..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as somaartigomzn from tbvenda_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_MZN() na VENDA_DETALHES_LOJA_JARDIM ..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_MZN() at SELLING_DETAILS_SHOP_JARDIM..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_MZN() {
        String sql = "select sum( PRECO_ARTIGO_MZN ) as Psomaartigomzn from tbvenda_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.conexao.close();
                    this.rs.close();
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_MZN() na VENDA_DETALHES_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_MZN() in SELLING_DETAILS_SHOP_JARDIM..! \n"+err, "Attention", 0);
            }            
        }
    }
    
    private void calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as somatotalmzn from tbvenda_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_MZN() na VENDA_DETALHES_LOJA_JARDIM..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Total_MZN() at SELLING_DETAILS_SHOP_JARDIM..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_MZN() {
        String sql = "select sum( PRECO_TOTAL_MZN ) as Psomatotalmzn from tbvenda_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_MZN() na VENDA_DETALHES_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_MZN() in SELLING_DETAILS_SHOP_JARDIM..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Artigo_USD() {
        String sql = "select sum( PRECO_ARTIGO_USD ) as somaartigousd from tbvenda_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Artigo_USD() na VENDA_DETALHES_LOJA_JARDIM..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Artigo_USD() at SELLING_DETAILS_SHOP_JARDIM..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Artigo_USD() {
        String sql = "select sum( PRECO_ARTIGO_USD ) as Psomaartigousd from tbvenda_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Artigo_USD() na VENDA_DETALHES_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Artigo_USD() in SELLING_DETAILS_SHOP_JARDIM..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void calc_Preco_Total_USD() {
        String sql = "select sum( PRECO_TOTAL_USD ) as somatotalusd from tbvenda_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Total_USD() na VENDA_DETALHES_LOJA_JARDIM..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Total_USD() at SELLING_DETAILS_SHOP_JARDIM..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Total_USD() {
        String sql = "select sum( PRECO_TOTAL_USD ) as Psomatotalusd from tbvenda_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.conexao.close();
                    this.rs.close();
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Total_USD() na VENDA_DETALHES_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Total_USD() in SELLING_DETAILS_SHOP_JARDIM..! \n"+err, "Attention", 0);
            }            
        }
    }
    
    private void calc_Preco_Venda_MZN() {
        String sql = "select sum( PRECO_VENDA ) as somavendamzn from tbvenda_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Venda_MZN() na VENDA_DETALHES_LOJA_JARDIM..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR IN calc_Preco_Venda_MZN() at SELLING_DETAILS_SHOP_JARDIM..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Venda_MZN() {
        String sql = "select sum( PRECO_VENDA ) as Psomavendamzn from tbvenda_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.conexao.close();
                    this.rs.close();
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Venda_MZN() na VENDA_DETALHES_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Venda_MZN() in SELLING_DETAILS_SHOP_JARDIM..! \n"+err, "Attention", 0);
            }            
        }
    }
    
    private void calc_Preco_Lucro_MZN() {
        String sql = "select sum( LUCRO ) as somalucro from tbvenda_jardim";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO NO calc_Preco_Lucro_MZN() na VENDA_DETALHES_LOJA_JARDIM..! "+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR in calc_Preco_Lucro_MZN() at SELLING_DETAILS_SHOP_JARDIM..! "+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void pesquisar_calc_Preco_Lucro_MZN() {
        String sql = "select sum( LUCRO ) as Psomalucro from tbvenda_jardim where DESIGNAÇÃO like ? || MARCA like ? || CATEGORIA like ? || VENDIDO_POR like ? || DATA_HORA like ?";
        ...
        try{
            ...
            try {
                ...
                this.rs.close();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "ERRO AO TENTAR pesquisar_calc_Preco_Lucro_MZN() na VENDA_DETALHES_LOJA_JARDIM..! \n"+err, "Atenção", 0);
                } else {
                    JOptionPane.showMessageDialog(null, "ERROR WHILE TRYING TO pesquisar_calc_Preco_Lucro_MZN() in SELLING_DETAILS_SHOP_JARDIM..! \n"+err, "Attention", 0);
                }            
            } catch (SQLException ex) {
                Logger.getLogger(TelaVenda_LojaJardim_Detalhes.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void configPort() {
        ...
        lblloja_1.setText("# LOJA_JARDIM");
    }

    @Override
    public void configEng() {
        btnRemover.setText("Remove");
        lblloja_1.setText("# SHOP_JARDIM");
    }
    ...
    public void remover1() {
        String sql = "delete from tbvenda_jardim where ID = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                JOptionPane.showMessageDialog(null," ERRO AO TENTAR DELETAR VENDA_DETALHES_LOJA_JARDIM...! "+Er, "Atenção",0);
            } else {
                JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO SELLING_DETAILS_SHOP_JARDIM DELETE...! "+Er, "Attention",0);
            }
    ...
    public void remover2() {
        int[] sr = tabela.getSelectedRows();
        String sql = "delete from tbvenda_jardim where ID in (?, ?)";
        model = (DefaultTableModel) tabela.getModel();
        try {
            pst = conexao.prepareStatement(sql);
