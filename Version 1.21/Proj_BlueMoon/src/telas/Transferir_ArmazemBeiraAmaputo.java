...
public final class Transferir_ArmazemBeiraAmaputo extends JFrame implements ActionListener, Config_idiomas {
    ...
    public Transferir_ArmazemBeiraAmaputo() throws SQLException {
    ...
    private void Janela() {        
        if(Idiomas.getPort() == true) {
            setTitle("TRANSFERIR PARA ARMAZÉM DO MAPUTO");
        } else {
            setTitle("TRANSFER TO WAREHOUSE MAPUTO");
        }
        setSize(1000, 540);        
    ...
    private void configView() throws SQLException {
        ...
        lblloja_1.setBounds(810, 2, 200, 21);
    ...
    private void configListarDesignacao() {
        ...
        String sql = "select * from tbarmazem_beira where MARCA = ? and CATEGORIA = ? and DESIGNAÇÃO like '%" + txtDesignacao.getText() + "%'";
        ...
        try {
                ...
                scroll_listaDesignacao.setVisible(true);
                    ...
                    listaDesignacao.addMouseListener(new MouseAdapter() {
                        ...
                        public void mouseClicked(MouseEvent e) {
                            ...
                            String sql2 = "select * from tbarmazem_beira where DESIGNAÇÃO = ?";
                            try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - Transferir_ArmazemBeiramaputo \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - Transferir_ArmazemBeiramaputo \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() - Transferir_ArmazemBeiramaputo \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca() - Transferir_ArmazemBeiramaputo \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            txtCategoria = new JComboBox<>(comboBoxModel);
                ...
                if(Idiomas.getPort() == true) {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();        
                        JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - Transferir_ArmazemBeiramaputo \n" + erro, "Atenção", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();
                        JOptionPane.showMessageDialog(null, "Error in txtCategoria()- Transferir_ArmazemBeiramaputo \n" + erro, "Attention", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                    }
            }
    ...
    private void temp_loja_Maputo() throws SQLException {
        Statement ctemp = conexao.createStatement();
        ctemp.executeUpdate("create temporary table temp_tbarmazem_maputo like tbarmazem_maputo");         
    }
    
    private void tabelaDAO() {
        String sql = "SELECT ID, DESIGNAÇÃO, MARCA, CATEGORIA, QUANTIDADE FROM temp_tbarmazem_maputo";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() - Transferir_ArmazemBeiramaputo", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERROR IN DAO_TABLE() - Transferir_ArmazemBeiramaputo", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }            
    ...
    private void salvar() throws SQLException {
        String sql = "insert into temp_tbarmazem_maputo(designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd) values (?, ?, ?, ?, ?, ?, ?)";
        try {
            pst = conexao.prepareStatement(sql);
            ...
            if(Idiomas.getPort() == true) {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO AO TENTAR SALVAR UMA VENDA - Transferir_ArmazemBeiramaputo !", "AVISO", 0);
            } else {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE WHEN TRYING TO SAVE - Transferir_ArmazemBeiramaputo !", "WARNING", 0);
            }
        }
        
        String sql2 = "select sum( QUANTIDADE ) as somatemparmazem_maputo from temp_tbarmazem_maputo";
        int somaVlr = 0;
        try{
            rs = conexao.createStatement().executeQuery(sql2);
            
            while (rs.next()) {
                somaVlr = rs.getInt("somatemparmazem_maputo");
            }          
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERRO NO save() somatemploja_armazem_maputo - Transferir_ArmazemBeiramaputo ..! "+err, "Atenção", 0);
            } else {
                this.rs.close();
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERROR IN save() somatemploja_armazem_maputo - Transferir_ArmazemBeiramaputo ..! "+err, "Attention", 0);
            }            
        }        
    }
    ...
    private void configTransferir1() throws SQLException {
        String sqlTemp = "select DESIGNAÇÃO, QUANTIDADE from temp_tbarmazem_maputo";
        
        pst = conexao.prepareStatement(sqlTemp);
        rs = pst.executeQuery();
        
        String sqlUpdate_Loja1 = "update tbarmazem_beira set QUANTIDADE = QUANTIDADE - ? WHERE DESIGNAÇÃO = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configUTransferir1() - Transferir_armazemMaputo!", "AVISO", 0);
            } else {
                this.pst.close();
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configTransferir1() - Transferir_armazemMaputo!", "WARNING", 0);
            }
        }
    }
    
    private void configTransferirMaputo() throws SQLException {
        String sqlTemp = "select DESIGNAÇÃO, QUANTIDADE from temp_tbarmazem_maputo";
        
        pst = conexao.prepareStatement(sqlTemp);
        rs = pst.executeQuery();
        
        String sqlUpdate_Loja2 = "update tbarmazem_maputo set QUANTIDADE = QUANTIDADE + ? WHERE DESIGNAÇÃO = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configUTransferirMaputo() - Transferir_ArmazemBeiramaputo - Update Armazem do Maputo!", "AVISO", 0);
            } else {
                this.pst.close();
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configTransferirMaputo() - Transferir_ArmazemBeiramaputo - Update Maputo Warehouse!", "WARNING", 0);
            }
        }
    }
    
    private void limparTabela() {
        String sql = "drop temporary table temp_tbarmazem_maputo";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no limparTabela() - Transferir_armazemDomaputo!", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in limparTabela() - Transferir_maputoWarehouse!", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public void remover() {
        String sql = "delete from temp_tbarmazem_maputo where ID = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null," ERRO no remover()...! "+Er, "Atenção",0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO DELETE in remove()...! "+Er, "Attention",0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraAmaputo.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public void actionPerformed(ActionEvent evt) {
        if(evt.getSource() == btnAdicionar) {
            ...
            try {
                configTransferir1();
                configTransferirMaputo();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "Transferido com sucesso para ARMAZÉM DO MAPUTO!", "Atenção", 1);
                } else {
                    JOptionPane.showMessageDialog(null, "Successfully Transferred to MAPUTO WAREHOUSE!", "Successfully", 1);
                }
            } catch (SQLException ex) {
                Logger.getLogger(Transferir_LojaJardimAmaputo.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void configPort() {
        ...
        lblloja_1.setText("#ARMAZÉM_BEIRA");
        ...
        txtuser.setText("Armazém do Maputo");
    }
    ...
    public void configEng() {
        ...
        lblloja_1.setText("#BEIRA WAREHOUSE");
        ...
        txtuser.setText("Maputo Warehouse");
    }
}