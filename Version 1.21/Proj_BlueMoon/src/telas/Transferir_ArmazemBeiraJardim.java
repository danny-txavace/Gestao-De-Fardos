...
public final class Transferir_ArmazemBeiraJardim extends JFrame implements ActionListener, Config_idiomas {
    ...
    public Transferir_ArmazemBeiraJardim() throws SQLException {
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - Transferir_ArmazemBeiraJardim \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - Transferir_ArmazemBeiraJardim \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() - Transferir_ArmazemBeiraJardim \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca() - Transferir_Loja2Jardim \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            txtCategoria = new JComboBox<>(comboBoxModel);
                ...
                if(Idiomas.getPort() == true) {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();        
                        JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - Transferir_ArmazemBeiraJardim \n" + erro, "Atenção", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();
                        JOptionPane.showMessageDialog(null, "Error in txtCategoria()- Transferir_Loja2Jardim \n" + erro, "Attention", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                    }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() - Transferir_ArmazemBeiraJardim", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERROR IN DAO_TABLE() - Transferir_ArmazemBeiraJardim", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }            
    ...
    private void salvar() throws SQLException {
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO AO TENTAR SALVAR UMA VENDA - Transferir_ArmazemBeiraJardim !", "AVISO", 0);
            } else {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE WHEN TRYING TO SAVE - Transferir_ArmazemBeiraJardim !", "WARNING", 0);
            }
        }
        ...
        try{
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERRO NO save() somatemploja_Jardim - Transferir_ArmazemBeiraJardim ..! "+err, "Atenção", 0);
            } else {
                this.rs.close();
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERROR IN save() somatemploja_Jardim - Transferir_ArmazemBeiraJardim ..! "+err, "Attention", 0);
            }            
        }        
    }
    ...
    private void configTransferir1() throws SQLException {
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configUTransferir1() - Transferir_ArmazemBeiraJardim - Update configTransferir1!", "AVISO", 0);
            } else {
                this.pst.close();
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configTransferir1() - Transferir_ArmazemBeiraJardim - Update configTransferir1!", "WARNING", 0);
            }
        }
    }
    ...
    private void configTransferirJardim() throws SQLException {
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configUTransferirJardim() - Transferir_ArmazemBeiraJardim - Update Loja Jardim!", "AVISO", 0);
            } else {
                this.pst.close();
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configTransferirJardim() - Transferir_ArmazemBeiraJardim - Update Jardim Shop!", "WARNING", 0);
            }
        }
    }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no limparTabela() - Transferir_ArmazemBeiraJardim!", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in limparTabela() - Transferir_ArmazemBeiraJardim!", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null," ERRO no remover() - Transferir_ArmazemBeiraJardim...! "+Er, "Atenção",0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO DELETE in remove() - Transferir_ArmazemBeiraJardim...! "+Er, "Attention",0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemBeiraJardim.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
