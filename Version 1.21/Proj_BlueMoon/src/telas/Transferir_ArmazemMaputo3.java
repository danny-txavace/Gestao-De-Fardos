...
public final class Transferir_ArmazemMaputo3 extends JFrame implements ActionListener, Config_idiomas {
    ...
    public Transferir_ArmazemMaputo3() throws SQLException {
    ...
    private void Janela() {        
        if(Idiomas.getPort() == true) {
            setTitle("TRANSFERIR PARA LOJA 3");
        } else {
            setTitle("TRANSFER TO SHOP_3");
        }
        setSize(1000, 540);        
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - Transferir_ArmazemMaputo3 \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - Transferir_ArmazemMaputo3 \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() - Transferir_ArmazemMaputo3 \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca() - Transferir_ArmazemMaputo3 \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            txtCategoria = new JComboBox<>(comboBoxModel);
                ...
                if(Idiomas.getPort() == true) {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();        
                        JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - Transferir_ArmazemMaputo3 \n" + erro, "Atenção", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();
                        JOptionPane.showMessageDialog(null, "Error in txtCategoria()- Transferir_ArmazemMaputo3 \n" + erro, "Attention", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                    }
            }
    ...
    private void temp_loja_3() throws SQLException {
        Statement ctemp = conexao.createStatement();
        ctemp.executeUpdate("create temporary table temp_tbloja_3 like tbloja_3");         
    }
    
    private void tabelaDAO() {
        String sql = "SELECT ID, DESIGNAÇÃO, MARCA, CATEGORIA, QUANTIDADE FROM temp_tbloja_3";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERRO NA TABELA_DAO() - Transferir_ArmazemMaputo3", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERROR IN DAO_TABLE() - Transferir_ArmazemMaputo3", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }            
    ...
    private void salvar() throws SQLException {
        String sql = "insert into temp_tbloja_3(designação, marca, categoria, unidade, quantidade, preco_artigo_mzn, preco_artigo_usd) values (?, ?, ?, ?, ?, ?, ?)";
        try {
            pst = conexao.prepareStatement(sql);
            ...
            if(Idiomas.getPort() == true) {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO AO TENTAR SALVAR UMA VENDA - Transferir_ArmazemMaputo3 !", "AVISO", 0);
            } else {
                this.pst.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE WHEN TRYING TO SAVE - Transferir_ArmazemMaputo3 !", "WARNING", 0);
            }
        }
        
        String sql2 = "select sum( QUANTIDADE ) as somatemploja_3 from temp_tbloja_3";
        int somaVlr = 0;
        try{
            rs = conexao.createStatement().executeQuery(sql2);
            
            while (rs.next()) {
                somaVlr = rs.getInt("somatemploja_3");
            }          
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERRO NO save() somatemploja_3 - Transferir_ArmazemMaputo3 ..! "+err, "Atenção", 0);
            } else {
                this.rs.close();
                this.conexao.close();
                this.pst.close();
                JOptionPane.showMessageDialog(null, "ERROR IN save() somatemploja_3 - Transferir_ArmazemMaputo3 ..! "+err, "Attention", 0);
            }            
        }        
    }
    ...
    private void configTransferir1() throws SQLException {
        String sqlTemp = "select DESIGNAÇÃO, QUANTIDADE from temp_tbloja_3";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configUTransferir1() - Transferir_ArmazemMaputo3 - Update Maputo!", "AVISO", 0);
            } else {
                this.pst.close();
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configTransferir1() - Transferir_ArmazemMaputo3 - Update Maputo!", "WARNING", 0);
            }
        }
    }
    
    private void configTransferir3() throws SQLException {
        String sqlTemp = "select DESIGNAÇÃO, QUANTIDADE from temp_tbloja_3";
        
        pst = conexao.prepareStatement(sqlTemp);
        rs = pst.executeQuery();
        
        String sqlUpdate_Loja2 = "update tbloja_3 set QUANTIDADE = QUANTIDADE + ? WHERE DESIGNAÇÃO = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configUTransferir3() - Transferir_ArmazemMaputo3 - Update Loja 3!", "AVISO", 0);
            } else {
                this.pst.close();
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configTransferir3() - Transferir_ArmazemMaputo3 - Update Shop 3!", "WARNING", 0);
            }
        }
    }
    
    private void limparTabela() {
        String sql = "drop temporary table temp_tbloja_3";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no limparTabela() - Transferir_ArmazemMaputo3!", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in limparTabela() - Transferir_ArmazemMaputo3!", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public void remover() {
        String sql = "delete from temp_tbloja_3 where ID = ?";
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null," ERRO no remover() - Transferir_ArmazemMaputo3...! "+Er, "Atenção",0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,"ERROR WHILE TRYING TO DELETE in remove() - Transferir_ArmazemMaputo3...! "+Er, "Attention",0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public void actionPerformed(ActionEvent evt) {
        if(evt.getSource() == btnAdicionar) {
            ...
            try {
                ...
                configTransferir3();
                if(Idiomas.getPort() == true) {
                    JOptionPane.showMessageDialog(null, "Transferido com sucesso para LOJA 3!", "Atenção", 1);
                } else {
                    JOptionPane.showMessageDialog(null, "Successfully Transferred to SHOP 3!", "Successfully", 1);
                }
            } catch (SQLException ex) {
                Logger.getLogger(Transferir_ArmazemMaputo3.class.getName()).log(Level.SEVERE, null, ex);
            }
