...
public final class Transferir_Loja3Abeira extends JFrame implements ActionListener, Config_idiomas {
    ...
    public Transferir_Loja3Abeira() throws SQLException {
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarDesignacao() - Transferir_Loja3beira \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_Loja3Abeira.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarDesignacao() - Transferir_Loja3beira \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_Loja3Abeira.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();        
                    JOptionPane.showMessageDialog(null, "Erro no configListarMarca() - Transferir_Loja3beira \n" + erro, "Atenção", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_Loja3Abeira.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, "Error in configListarMarca() - Transferir_Loja3beira \n" + erro, "Attention", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_Loja3Abeira.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            txtCategoria = new JComboBox<>(comboBoxModel);
                ...
                if(Idiomas.getPort() == true) {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();        
                        JOptionPane.showMessageDialog(null, "Erro no txtCategoria() - Transferir_Loja3beira \n" + erro, "Atenção", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(Transferir_Loja3Abeira.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {
                    try {
                        ...
                        this.rs.close();
                        this.conexao.close();
                        JOptionPane.showMessageDialog(null, "Error in txtCategoria()- Transferir_Loja3beira \n" + erro, "Attention", 0);
                    } catch (SQLException ex) {
                        Logger.getLogger(Transferir_Loja3Abeira.class.getName()).log(Level.SEVERE, null, ex);
                    }
            }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                ...
                try {
                    ...
                    this.rs.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null,er + " ERROR IN DAO_TABLE() - Transferir_Loja3beria", "TBL   DAO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_Loja3Abeira.class.getName()).log(Level.SEVERE, null, ex);
                }
            }            
    ...
    private void configTransferir1() throws SQLException {
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                ...
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no configUTransferir1() - Transferir_armazemBeira - Update Loja 3!", "AVISO", 0);
            } else {
                this.pst.close();
                this.rs.close();
                this.conexao.close();
                JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in configTransferir1() - Transferir_armazemBeira - Update Shop 3!", "WARNING", 0);
            }
        }
    }
        ...
        try {
            ...
            if(Idiomas.getPort() == true) {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" MENSAGEM DE ERRO no limparTabela() - Transferir_Loja3beira!", "AVISO", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_Loja3Abeira.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
                try {
                    this.pst.close();
                    this.conexao.close();
                    JOptionPane.showMessageDialog(null, erro+" ERROR MESSAGE in limparTabela() - Transferir_Loja3beira!", "WARNING", 0);
                } catch (SQLException ex) {
                    Logger.getLogger(Transferir_Loja3Abeira.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
